...
$fn_get_data = function () {
  // Obtener el primer y último día del mes siguiente
  $first_day_of_next_month = date('Y-m-01', strtotime('+1 month'));
  $last_day_of_next_month = date('Y-m-t', strtotime('+1 month'));
  ...
  WHERE TBLTags.id IN (9, 10, 11, 12) 
    AND TBLTasks.duedate BETWEEN '$first_day_of_next_month' AND '$last_day_of_next_month'
